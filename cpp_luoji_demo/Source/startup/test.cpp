...
void NVram_test(void)
{
    ...
    //0xFFFF是1111 1111 1111 1111;
    //0x63是  0000 0000 0110 0011;
    //因为powerpc是大端存储，所以0x63存储时是反过来的
    //程序读取出来的信息：numb是65379，也就是1111 1111 0110 0011
    //0xFFFF的高位加上0x63的低位，0xFF63。所以这个NVram也是普通的一次只能写入一个字节。
